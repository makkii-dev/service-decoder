...
jobs="$(./bash_compile.sh dev.makkii.Demo ./src/dev/makkii/Demo.java && java -jar ./avm/avm.jar deploy ./build/dapp.jar)"
...
cp build/dapp.jar ../tool-deploy && cd ../tool-deploy && node index.js && cd ../tool-decode-raw-transaction